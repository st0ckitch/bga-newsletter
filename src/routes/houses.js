...
// The house palette lives in src/brand.js with the rest of the branding.
const HOUSE_COLORS = palette.houseColors;
...
router.post('/houses', requireManager, (req, res) => {
  ...
  const color = HOUSE_COLORS[name.toLowerCase()] || palette.brand;
