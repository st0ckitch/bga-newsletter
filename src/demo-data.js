...
const DEMO_ARTICLES = [
  ...
  },
  {
    ...
    body:
      'On Friday, BGA hosted an Inter-School Friendly Tennis Tournament with the European School, bringing together 24 student participants for an exciting day of competition and sportsmanship.\n\nOur team delivered an outstanding performance across both the singles and doubles draws, and emerged as the overall tournament champions.\n\nCongratulations to all participants for their dedication, teamwork, and excellent sportsmanship!',
...
function fillDemoData(userId) {
  ...
  const demoEvents = [
    ...
    { title: 'PCA Meeting', date: addDays(issueDate, 5), time_note: '8:30-10:00am', location: 'BGA Meeting Room' },
  ...
  // Masthead background behind the wordmark - only when none is set, so a
